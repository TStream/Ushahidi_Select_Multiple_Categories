...
class Country_ModelTest extends PHPUnit_Framework_TestCase {
	...
	public function testGetCountryByCode()
	{
		...
		// Use invalid country
		$invalid = Country_Model::get_country_by_code('WW');
		$this->assertNull($invalid);
	}
	...
	{
		// Use valid country
		$valid = Country_Model::get_countries_list();
		$this->assertGreaterThanOrEqual(1, count($valid));
	...
	{
		// Use valid country
		$valid = Country_Model::get_cities();
		$this->assertGreaterThanOrEqual(1, count($valid));
